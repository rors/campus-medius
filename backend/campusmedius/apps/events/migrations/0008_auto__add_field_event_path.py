...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Event.path'
        db.add_column(u'events_event', 'path', self.gf('django.contrib.gis.db.models.fields.MultiLineStringField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Event.path'
        db.delete_column(u'events_event', 'path')
    ...
    models = {
        ...
        u'events.event': {
            ...
            'path': ('django.contrib.gis.db.models.fields.MultiLineStringField', [], {'null': 'True'}),
